...
const char* AWS_endpoint = "a16bnyd1eg3wsb-ats.iot.ap-southeast-1.amazonaws.com"; //MQTT broker ip
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect("test")) {
      ...
      client.publish("/things/test/shadow/update/accepted", "hello world");
      // ... and resubscribe
...
void loop() {
  ...
  Serial.println("client connect check finishhed");
  delay(10);
  client.loop();
  Serial.println("loop succeeded");
  delay(10);
