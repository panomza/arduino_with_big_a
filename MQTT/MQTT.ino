...
const char *ssid =  "HTR-MK";   // name of your WiFi network
const char *password =  "hatariled1"; // password of the WiFi network

const byte SWITCH_PIN = 0;           // Pin to control the light with
const char *ID = "Example_Switch1";  // Name of our device, must be unique
const char *TOPIC = "room/light";  // Topic to subcribe to

//IPAddress broker(198,211,100,233); // IP address of your MQTT broker eg. 192.168.1.50
#define server "iot.hatari.cc"
